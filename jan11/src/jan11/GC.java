 ...
 * 3. 가비지 컬렉션은 객체입니다.
 * 4. 가비지 컬랙션의 대상은 살아있는 스레드가 더이상 참조하지 않는 객체입니다.
 ...
 * 가비지 컬랙션이 되려면
 * 1. 참조변수에 null할당하기
 * 		참조변수에 null을 할당하면 이 변수 이전의 값은 더이상 접근할 수 없습니다.
 ...
 * 요청하기
 * 
 * 어떤 객체가 가비지 컬랙션의 대상이 되었다고 해서 바로 가비지 컬랙션이 동작하지 않습니다.
